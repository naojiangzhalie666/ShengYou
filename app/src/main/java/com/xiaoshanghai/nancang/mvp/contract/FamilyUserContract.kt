...
interface FamilyUserContract {
    ...
    interface Presenter {
        ...
        fun getUserIncome(refresh: RefreshLayout?, userId: String?,clanId: String?, startTime: String?)
    ...
    interface Model {
        ...
        fun getUserIncome(current: String?, size: String?, userId: String?, clanId: String?, startTime: String?): HttpObservable<BaseResponse<HomeRoomResult<MutableList<UserIncome>>>>
