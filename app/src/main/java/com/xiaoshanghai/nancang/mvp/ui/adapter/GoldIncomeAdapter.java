...
public class GoldIncomeAdapter extends BaseSectionQuickAdapter<ChiliIncomeHeaderBean, BaseViewHolder> {

    public GoldIncomeAdapter(@Nullable List<ChiliIncomeHeaderBean> data) {
        super(R.layout.adapter_income_header, data);
        setNormalLayout(R.layout.adapter_gold_income);
