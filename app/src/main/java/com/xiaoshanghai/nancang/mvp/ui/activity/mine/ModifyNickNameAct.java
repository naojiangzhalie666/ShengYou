...
public class ModifyNickNameAct extends BaseMvpActivity implements TitleBarClickCallback {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        etNickname.setText(reslut.getUserName());
