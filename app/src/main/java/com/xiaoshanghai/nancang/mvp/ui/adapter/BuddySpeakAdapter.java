...
public class BuddySpeakAdapter extends BaseQuickAdapter<MyFollowResult, BuddySpeakAdapter.Holder> {


    public BuddySpeakAdapter() {
        super(R.layout.adapter_speak_buddy);
    }
