...
import com.xiaoshanghai.nancang.mvp.ui.adapter.AttentionSelectAdapter;
...
public class MyAttentionSelectFragment extends BaseMvpFragment<AttentionSelectPresenter> implements AttentionSelectContract.View, OnRefreshLoadMoreListener {
    ...
    private AttentionSelectAdapter mAdapter;

    private OnFriendsSelectCallback mCallback;

    public static MyAttentionSelectFragment newInstance() {
        return new MyAttentionSelectFragment();
    }
    ...
    private void init() {
        ...
        mAdapter = new AttentionSelectAdapter();
