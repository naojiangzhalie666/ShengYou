...
import com.xiaoshanghai.nancang.mvp.ui.adapter.BuddySelectAdapter;
...
public class BuddySelectFragment extends BaseMvpFragment<BuddySelectPresenter> implements BuddySelectContract.View, OnRefreshLoadMoreListener {
    ...
    private BuddySelectAdapter mAdapter;

    private OnFriendsSelectCallback mCallback;

    public static BuddySelectFragment newInstance() {
        return new BuddySelectFragment();
    }
    ...
    protected void onLazyLoad() {
        mAdapter = new BuddySelectAdapter();
...
//                ActStartUtils.startAct(BuddySelectFragment.this.getActivity(), HomePageAct.class, bundle);
//            }
        });
