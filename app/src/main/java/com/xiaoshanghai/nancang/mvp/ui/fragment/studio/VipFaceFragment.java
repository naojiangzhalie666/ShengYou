...
public class VipFaceFragment extends BaseFragment {
    ...
    public static VipFaceFragment newInstance() {
        return new VipFaceFragment();
    }
    ...
    public int setLayoutId() {
        return R.layout.fragment_vip_face;
    }
    ...
    private void initView() {
        ...
        ArrayList<RoomFace> roomFace = (ArrayList<RoomFace>) RoomFaceManager.Companion.getRoomVipFace();
