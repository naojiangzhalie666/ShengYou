...
import com.xiaoshanghai.nancang.mvp.model.CashRecordModel;
...
public class CashRecordPresenter extends BasePresenter<CashRecordContract.View> implements CashRecordContract.Presenter {
    ...
    public void selectTime(String date) {
        ...
        TimePickerView pvTime = new TimePickerBuilder(((BaseActivity)getView()), new OnTimeSelectListener() {
            @Override
...
//                .setContentSize(18)//滚轮文字大小
                ...
                .setDecorView(((BaseActivity) (getView())).getWindow().getDecorView().findViewById(android.R.id.content))
                .build();
        pvTime.show();
    ...
    public void getIncomeList(RefreshLayout refresh,String userId, String date) {
        ...
        model.getCashList(mPage + "", size + "",userId,replace)
