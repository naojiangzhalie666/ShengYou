...
public interface ChiliIncomeContract {
    ...
    interface Model {
        ...
        HttpObservable<BaseResponse<HomeRoomResult<List<ChiliIncomeResult>>>> getMyChiliIncomeList(String current, String size, String date);
