...
interface ChiliGiftIncomeContract {
    ...
    interface Presenter {
         ...
         * @param date
         */
        fun getGoldGiftList(refresh: RefreshLayout?, date: String?)
    }

    interface Model {

        fun getChiliGiftList(current: String?, size: String?, date: String?): HttpObservable<BaseResponse<HomeRoomResult<List<GoldGiftResult?>?>?>?>?
    }
