package com.xiaoshanghai.nancang.thirdpush;
...
import com.xiaoshanghai.nancang.utils.BrandUtil;
...
//                DemoLog.i(TAG, "push custom data key: " + key + " value: " + value);
    ...
    private static OfflineMessageBean offlineMessageBeanValidCheck(OfflineMessageBean bean) {
        if (bean == null) {
            ...
            String label = String.valueOf(packageManager.getApplicationLabel(BaseApplication.getApplication().getApplicationInfo()));
...
//            DemoLog.e(TAG, "unknown version: " + bean.version + " or action: " + bean.action);
    ...
    public static boolean redirect(final OfflineMessageBean bean) {
        if (bean.action == OfflineMessageBean.REDIRECT_ACTION_CHAT) {
            ...
            Intent intent = new Intent(BaseApplication.getApplication(), ChatActivity.class);
...
//                                DemoLog.e(TAG, "addInvitedSignaling code: " + code + " desc: " + desc);
                            ...
                            public void onSuccess() {
                                ((TRTCAVCallImpl)(TRTCAVCallImpl.sharedInstance(BaseApplication.getApplication()))).
        ...
        Intent intent = new Intent(BaseApplication.getApplication(), MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        BaseApplication.getApplication().startActivity(intent);
        return true;
    }
