...
public class ToastUtils {
    ...
    private static int yOffset =
            (int) (64 * BaseApplication.getApplication().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) BaseApplication.getApplication().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//        }
    ...
    private static void show(CharSequence text, int duration) {
        ...
        if (customView != null) {
            ...
            ((TextView) customView.findViewById(R.id.tvToast)).setText(text);
        } else {
