 ...
 * IM 使用帮助 请勿删注释代码
 */
public class PublicChatLayoutHelper {

    private static final String TAG = PublicChatLayoutHelper.class.getSimpleName();
    ...
    public PublicChatLayoutHelper(BaseView baseView,Context context) {
    ...
    public void customizeChatLayout(final PublicChatLayout layout) {
...
//        });
        ...
        //====== InputLayout使用范例 ======//
        PublicInputLayout inputLayout = layout.getInputLayout();
