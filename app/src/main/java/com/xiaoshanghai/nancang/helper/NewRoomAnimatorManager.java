...
public class NewRoomAnimatorManager implements AnimationListener.Stop {
    ...
    private NewRoomAnimatorManager() {
    }
    ...
    private static class SingletonInstance {
        private static final NewRoomAnimatorManager INSTANCE = new NewRoomAnimatorManager();
    }

    public static NewRoomAnimatorManager getInstance() {
