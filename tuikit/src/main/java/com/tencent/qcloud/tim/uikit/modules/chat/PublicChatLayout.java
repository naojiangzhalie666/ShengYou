...
import com.tencent.qcloud.tim.uikit.modules.chat.base.PublicAbsChatLayout;
...
public class PublicChatLayout extends PublicAbsChatLayout implements GroupChatManagerKit.GroupNotifyHandler {
    ...
    public PublicChatLayout(Context context) {
        super(context);
    }

    public PublicChatLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PublicChatLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
