...
public abstract class PublicAbsChatLayout extends PublicChatLayoutUI implements PublicIChatLayout {
    ...
    public PublicAbsChatLayout(Context context) {
        super(context);
    }

    public PublicAbsChatLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PublicAbsChatLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initListener() {
        ...
        getInputLayout().setChatInputHandler(new PublicInputLayout.ChatInputHandler() {
            @Override
    ...
    public void initDefault() {
        ...
        getInputLayout().setMessageHandler(new PublicInputLayout.MessageHandler() {
            @Override
            public void sendMessage(MessageInfo msg) {
                PublicAbsChatLayout.this.sendMessage(msg, false);
            }
        });
