...
abstract public class PublicInputLayoutUi extends LinearLayout implements IInputLayout {
    ...
    private static String TAG = PublicInputLayoutUi.class.getSimpleName();
    /**
     * 语音/文字切换输入控件
     */
...
//    protected ImageView mMoreInputButton;
    ...
    public PublicInputLayoutUi(Context context) {
        super(context);
        initViews();
    }

    public PublicInputLayoutUi(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initViews();
    }

    public PublicInputLayoutUi(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initViews() {
        ...
        inflate(mActivity, R.layout.public_chat_input_layout, this);
...
//        mMoreInputButton = findViewById(R.id.more_btn);
        ...
        mAtBtn = findViewById(R.id.at_btn);
    ...
    protected void assembleActions() {
        ...
        if (!mSendPhotoDisable) {
            action.setIconResId(R.drawable.icon_chat_picture);
