...
public abstract class PublicChatLayoutUI extends LinearLayout implements PublicIChatLayout {
    ...
    private PublicInputLayout mInputLayout;
    private NoticeLayout mNoticeLayout;
    private ChatInfo mChatInfo;
    private TextView mChatAtInfoLayout;

    public PublicChatLayoutUI(Context context) {
        super(context);
        initViews();
    }

    public PublicChatLayoutUI(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initViews();
    }

    public PublicChatLayoutUI(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initViews();
    }

    private void initViews() {
        inflate(getContext(), R.layout.public_chat_layout, this);
    ...
    @Override
    public PublicInputLayout getInputLayout() {
        return mInputLayout;
    }
