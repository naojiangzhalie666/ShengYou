...
public class TRTCVoiceRoomDef {
    ...
    public static class SeatInfo {
        ...
        public static final transient int STATUS_UNUSED = 0;    //麦位上没有人

        public static final transient int STATUS_USED = 1;      //麦位上有人

        public static final transient int STATUS_OPEN = 0;      //麦位没有被锁

        public static final transient int STATUS_CLOSE = 1;     //麦位被锁

        /// 【字段含义】座位状态 0(unused)/1(used)/2(close)
        public int     status;
        /// 【字段含义】座位状态 0(open)/1(close)
