...
public abstract class TRTCVoiceRoom {
     ...
     */
    public abstract void createRoom(String roomId, TRTCVoiceRoomDef.RoomParam roomParam, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    public abstract void enterRoom(String roomId, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 操作回调
     */
    public abstract void closeSeat(boolean isClose, TRTCVoiceRoomCallback.ActionCallback callback);
    ...
    /**
     * 在全局广播自定义（信令）消息，一般用于广播点赞和礼物消息
     *
     * @param cmd 命令字，由开发者自定义，主要用于区分不同消息类型
     * @param message 文本消息
     * @param callback 发送结果回调
     */
    public abstract void sendGlobalCustomMsg(String cmd, String message, TRTCVoiceRoomCallback.ActionCallback callback);
